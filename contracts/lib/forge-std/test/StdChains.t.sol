...
contract StdChainsTest is Test {
    ...
    function testSetChainFirstFails() public {
        ...
        setChain("anvil2", ChainData("Anvil", 31_337, "URL"));
    }

    function testChainBubbleUp() public {
        setChain("needs_undefined_env_var", ChainData("", 123_456_789, ""));
        vm.expectRevert(
    ...
    function testCannotSetChain_ChainIdExists() public {
        ...
        setChain("another_custom_chain", ChainData("", 123_456_789, ""));
    }
    ...
    function testSetNoEmptyAlias() public {
        ...
        setChain("", ChainData("", 123_456_789, ""));
    }
