...
library LiquidationLogic {
     ...
     * @dev If the Health Factor is below CLOSE_FACTOR_HF_THRESHOLD, the close factor is increased to
    ...
    function _getConfigurationData(
        ...
        internal
        view
        returns (IAToken, address, address, uint256)
    {
     ...
     * @param userCollateralBalance The collateral balance for the specific `collateralAsset` of the user being
     * liquidated
     * @param liquidationBonus The collateral bonus percentage to receive as result of the liquidation
     * @return The maximum amount that is possible to liquidate given all the liquidation constraints (user balance,
     * close factor)
