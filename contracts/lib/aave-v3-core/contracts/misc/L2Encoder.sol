...
contract L2Encoder {
     ...
     * @param referralCode referralCode Code used to register the integrator originating the operation, for potential
     * rewards.
    ...
    /**
     * @notice Encodes rebalance stable borrow rate parameters from standard input to compact representation of 1
     * bytes32
     * @param asset The address of the underlying asset borrowed
    ...
    /**
     * @notice Encodes set user use reserve as collateral parameters from standard input to compact representation of 1
     * bytes32
     * @param asset The address of the underlying asset borrowed
